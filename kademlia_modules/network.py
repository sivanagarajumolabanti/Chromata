...
from kademlia_modules.crawling import ValueSpiderCrawl
from kademlia_modules.crawling import NodeSpiderCrawl
    ...
    def __init__(self, ksize=20, alpha=3, node_id=None, storage=None):
        ...
        Args:
            ...
            storage: An instance that implements
                     :interface:`~kademlia_modules.storage.IStorage`
        """
        self.ksize = ksize
        self.alpha = alpha
