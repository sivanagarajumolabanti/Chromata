...
from kademlia_modules.node import Node, NodeHeap
from kademlia_modules.utils import gather_dict
...
class SpiderCrawl:
    ...
    def __init__(self, protocol, node, peers, ksize, alpha):
        ...
        Args:
            protocol: A :class:`~kademlia_modules.protocol.KademliaProtocol` instance.
            node: A :class:`~kademlia_modules.node.Node` representing the key we're
                  looking for
            peers: A list of :class:`~kademlia_modules.node.Node` instances that
    ...
    async def _find(self, rpcmethod):
        ...
        print("nearest:", str(tuple(self.nearest)))
        count = self.alpha
