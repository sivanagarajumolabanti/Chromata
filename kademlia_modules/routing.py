...
from kademlia_modules.utils import shared_prefix, bytes_to_bit_string
...
class KBucket:
    ...
    def get_nodes(self):
        print("nodes:", list(self.nodes.values()))
...
class RoutingTable:
    ...
    def add_contact(self, node):
        ...
        # Per section 4.2 of paper, split if the bucket has the nodez
    ...
    def find_neighbors(self, node, k=None, exclude=None):
        ...
        for neighbor in TableTraverser(self, node):
            ...
            if len(nodes) == k:
                break
        # print("neighbours:", list(neighbor))
